...
const brand = "'Playfair Display', Georgia, serif";
...
function NavButton({ active, onClick, children }) {
  return (
    <button
      onClick={onClick}
      className="md:w-full text-left px-4 py-2 rounded transition-colors whitespace-nowrap shrink-0"
      style={{
        fontFamily: sans,
        fontSize: 14,
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <aside
        className="w-full md:w-56 shrink-0 p-3 md:p-4 flex flex-col"
        style={{ borderBottom: `1px solid ${C.border}` }}
      >
        <div className="mb-3 md:mb-4 px-1 md:px-2 flex items-center gap-2">
          <span
            className="flex items-center justify-center rounded-full"
            style={{ width: 44, height: 44, backgroundColor: "#ffffff", flexShrink: 0 }}
          >
      ...
      <main className="flex-1 p-4 md:p-8 w-full md:max-w-2xl">
